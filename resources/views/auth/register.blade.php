...
<html lang="en">
    ...
    <body>
                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" method="post" action="{{ route('customer_register') }}">
                        ...
                        <div class="text-center p-t-115">
                            ...
                            <a class="txt2 font-weight-bold" style="color: #00ff40;" href="{{ url('\login') }}">
                                Login here
                            </a>
                        </div>
                    </form>
        ...
        <script>
    Swal.fire({"title":"Record Updated Successfully","text":"","timer":5000,"width":"32rem","heightAuto":true,"padding":"1.25rem","animation":true,"showConfirmButton":false,"showCloseButton":true,"toast":true,"type":"success","position":"top-end"});
</script>
    </body>
</html>